                ...
                <div className="row py-4">
                    <div className="col-lg-3 col-12 align-left">
                        <Link className="navbar-brand" to="/">
                            ...
                            <span className="text-light h5">Purple</span> <span
                            className="text-light h5 semi-bold-600">Buzz</span>
                        </Link>
                    ...
                    <div className="col-lg-3 col-md-4 my-sm-0 mt-4">
                        ...
                        <ul className="list-unstyled text-light light-300">
                            <li className="pb-2">
                                <i className='bx-fw bx bxs-chevron-right bx-xs'></i><Link
                                className="text-decoration-none text-light" to="/">Home</Link>
                            </li>
                            <li className="pb-2">
                                <i className='bx-fw bx bxs-chevron-right bx-xs'></i><Link
                                className="text-decoration-none text-light py-1" to="/about">About Us</Link>
                            </li>
                            <li className="pb-2">
                                <i className='bx-fw bx bxs-chevron-right bx-xs'></i><Link
                                className="text-decoration-none text-light py-1" to="/">Work</Link>
                            </li>
                            <li className="pb-2">
                                <i className='bx-fw bx bxs-chevron-right bx-xs'></i>
                                <Link className="text-decoration-none text-light py-1" to="/">Price</Link>
                            </li>
                            <li className="pb-2">
                                <i className='bx-fw bx bxs-chevron-right bx-xs'></i><Link
                                className="text-decoration-none text-light py-1" to="/contact">Contact</Link>
                            </li>
                        </ul>
                    </div>
                    <div className="col-lg-3 col-md-4 my-sm-0 mt-4">
                        ...
                        <ul className="list-unstyled text-light light-300">
                            <li className="pb-2">
                                <i className='bx-fw bx bxs-chevron-right bx-xs'></i><a
                                className="text-decoration-none text-light py-1" href="#">Branding</a>
                            </li>
                            <li className="pb-2">
                                <i className='bx-fw bx bxs-chevron-right bx-xs'></i><a
                                className="text-decoration-none text-light py-1" href="#">Business</a>
                            </li>
                            <li className="pb-2">
                                <i className='bx-fw bx bxs-chevron-right bx-xs'></i><a
                                className="text-decoration-none text-light py-1" href="#">Marketing</a>
                            </li>
                            <li className="pb-2">
                                <i className='bx-fw bx bxs-chevron-right bx-xs'></i><a
                                className="text-decoration-none text-light py-1" href="#">Social Media</a>
                            </li>
                            <li className="pb-2">
                                <i className='bx-fw bx bxs-chevron-right bx-xs'></i><a
                                className="text-decoration-none text-light py-1" href="#">Digital Solution</a>
                            </li>
                            <li className="pb-2">
                                <i className='bx-fw bx bxs-chevron-right bx-xs'></i><a
                                className="text-decoration-none text-light py-1" href="#">Graphic</a>
                            </li>
                        </ul>
                    </div>
                    <div className="col-lg-3 col-md-4 my-sm-0 mt-4">
                        ...
                        <ul className="list-unstyled text-light light-300">
                            <li className="pb-2">
                                <i className='bx-fw bx bx-phone bx-xs'></i><a
                                className="text-decoration-none text-light py-1"
                                href="tel:010-020-0340">010-020-0340</a>
                            </li>
                            <li className="pb-2">
                                <i className='bx-fw bx bx-mail-send bx-xs'></i><a
                                className="text-decoration-none text-light py-1"
                    ...
                    <div className="row pt-2">
                        ...
                        <div className="col-lg-3 col-sm-12">
                            <p className="text-lg-end text-center text-light light-300">
                                Designed by <a rel="sponsored" className="text-decoration-none text-light"
                        ...
                        <div className="col-lg-3 col-sm-12">
                            <p className="text-lg-end text-center text-light light-300">
                                Distributed by <a rel="sponsored" className="text-decoration-none text-light"
                                                  href="https://themewagon.com/"
                                                  target="_blank"><strong>Themewagon</strong></a>
                            </p>
                        </div>
                    </div>
                </div>
