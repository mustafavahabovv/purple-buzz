                    ...
                    <div className="row d-flex align-items-center py-5">
                        <div className="col-lg-6 text-start">
                            ...
                            <p className="light-300">
                                Vector illustration credit goes to <a rel="nofollow" href="http://freepik.com/"
                                                                      target="_blank">FreePik</a> website. Purple Buzz
                                is provided by TemplateMo. Lorem ipsum dolor sit amet, consectetur.
                            </p>
                        </div>
                        <div className="col-lg-6">
                            <img src="src/assets/img/banner-img-02.svg" alt=""/>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="pt-5 pb-3 d-lg-flex align-items-center gx-5">
                    ...
                    <div className="col-lg-9 row">
                        <div className="team-member col-md-4">
                            <img className="team-member-img img-fluid rounded-circle p-4"
                                 src="src/assets/img/team-01.jpg"
                                 alt="Card image"/>
                        ...
                        <div className="team-member col-md-4">
                            <img className="team-member-img img-fluid rounded-circle p-4"
                                 src="src/assets/img/team-02.jpg"
                                 alt="Card image"/>
                            <ul className="team-member-caption list-unstyled text-center pt-4 text-muted light-300">
                                <li>Jane Doe</li>
                        ...
                        <div className="team-member col-md-4">
                            <img className="team-member-img img-fluid rounded-circle p-4"
                                 src="src/assets/img/team-03.jpg"
                                 alt="Card image"/>
                            <ul className="team-member-caption list-unstyled text-center pt-4 text-muted light-300">
                                <li>Sam</li>
                                <li>Developer</li>
                ...
                <div className="container my-4">
                    ...
                    <div className="creative-content row py-3">
                        <div className="col-md-5">
                            <p className="text-muted col-lg-8 light-300">Lorem ipsum dolor sit amet, consectetur
                ...
                <div className="container my-4">
                    <div className="row">
                        <div className="banner-img col-lg-5">
                            <img src="src/assets/img/work.svg" className="rounded img-fluid" alt=""/>
                        </div>
                        <div className="banner-content col-lg-7 align-self-end">
                            ...
                            <p className="text-muted pb-5 light-300">
                                You are allowed to download and use this Purple Buzz template for your websites. You
                                are <strong>not allowed</strong> to re-distribute this template ZIP file on other
                                template websites. It is quite easy to simply copy and repost the ZIP file on any <a
                                rel="nofollow" href="https://www.google.com/search?q=free+css" target="_blank">Free CSS
                                collection</a> websites.</p>
                        </div>
                    </div>
                </div>
            </section>
                            ...
                            <form action="#" method="get"><h1 className="h2 text-center">Stay up to date with us</h1>
                                <div className="input-group py-3">
                                    ...
                                    <button
                                        ...
                                        type="submit">Subsribe
                                    </button>
                                </div>
                                <p className="text-center light-300">Lorem ipsum dolor sit amet, consectetur adipiscing
                                    elit, sed do eiusmod tempor incididunt labore et dolore magna aliqua.</p>
                            </form>
                        </div>
                    </div>
                </div>
